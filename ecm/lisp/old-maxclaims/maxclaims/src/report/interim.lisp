...
WITH interim AS (
    ...
    SELECT claim.claim_id, 
          ...
          , adjuster_id, claim.refer_to_underwriters
     FROM claim 
     LEFT JOIN timecard_interim AS ti 
      ...
      WHERE claim.status = 'Open'
       ...
       SELECT 'claim'::text AS Heading,
               ...
               sum(minutes) AS "Total Minutes", person_short_name(adjuster_id) AS "Examiner",
       ...
       GROUP BY t.claim_id, adjuster_id, refer_to_underwriters
 ), unbilled_gte AS (
